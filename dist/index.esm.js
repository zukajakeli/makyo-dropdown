...
var Dropdown = function (_a) {
    ...
    var menu = (jsxs("div", { ref: menuRef, className: 'absolute bg-white border border-gray-200 rounded-md shadow-lg overflow-hidden animate-scale-in text-gray-900', style: {
