...
var Dropdown = function (_a) {
    ...
    var menu = (jsxRuntime.jsxs("div", { ref: menuRef, className: clsx('bg-white border border-gray-200 rounded-md shadow-lg overflow-hidden animate-scale-in text-gray-900', usePortal ? 'fixed' : 'absolute'), style: usePortal
            ? {
